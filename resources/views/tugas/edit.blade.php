    ...
    <div class="form-container">
        <form action="{{ route('tugas.update', $tugas->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul_tugas" id="judul-tugas" value="{{ $tugas->judul_tugas }}" class="form-control" placeholder="Masukkan judul tugas" required>
            </div>
            <div class="form-group">
                <label for="mata-kuliah">Mata Kuliah</label>
                <input type="text" name="mata_kuliah" id="mata-kuliah" value="{{ $tugas->mata_kuliah }}" class="form-control" placeholder="Masukkan mata kuliah" required>
            </div>
            <div class="form-group">
                <label for="deskripsi-tugas">Deskripsi Tugas</label>
                <textarea name="deskripsi_tugas" id="deskripsi-tugas" class="form-control" rows="5" placeholder="Tambahkan deskripsi tugas" required>{{ $tugas->deskripsi_tugas }}</textarea>
            </div>
            <div class="form-group">
                <label for="deadline-tugas">Deadline Tugas</label>
                <input type="date" name="deadline_tugas" id="deadline-tugas" value="{{ $tugas->deadline_tugas }}" class="form-control" required>
            </div>
            <div class="form-group">
